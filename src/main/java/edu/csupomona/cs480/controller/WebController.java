...
public class WebController {
	...
	/**
	 * This is a simple example of how the HTTP API works. It returns a String "OK"
	 * in the HTTP response. To try it, run the web application locally, in your web
	 * browser, type the link: http://localhost:8080/cs480/ping
	 */
	 ...
	 * <p>
	 * Note, when it returns from the Spring, it will be automatically converted to
	 * JSON format.
	 * <p>
	...
	*
	*/
	@RequestMapping(value = "/cs480/user/whatever", method = RequestMethod.GET)
	String printSomething() {
		return "Whatever..";
	}

	@RequestMapping(value = "/cs480/user/johne", method = RequestMethod.GET)
	String printSomethingByJohn() {
		return "Hello confusion.";
	}
